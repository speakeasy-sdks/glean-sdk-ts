 ...
 */
export function indexingTroubleshootingDatasourceDocumentsDebug(
  client: GleanCore,
...
> {
  ...
  const path = pathToFunc("/api/index/v1/debug/{datasource}/documents")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.DebugDocumentsResponse$inboundSchema, {
