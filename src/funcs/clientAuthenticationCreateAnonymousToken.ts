 ...
 */
export function clientAuthenticationCreateAnonymousToken(
  client: GleanCore,
...
> {
  const path = pathToFunc("/rest/api/v1/createanonymoustoken")();
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["400", "403", "429", "4XX", "5XX"],
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.CreateAuthTokenResponse$inboundSchema),
