 ...
 */
export function clientDisplayableListsDelete(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeletedisplayablelistsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.DeleteDisplayableListsRequest, {
    explode: true,
  });

  const path = pathToFunc("/rest/api/v1/deletedisplayablelists")();
