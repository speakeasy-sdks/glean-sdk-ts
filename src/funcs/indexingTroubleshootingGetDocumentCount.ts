 ...
 */
export function indexingTroubleshootingGetDocumentCount(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.GetDocumentCountRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GetDocumentCountResponse$inboundSchema),
