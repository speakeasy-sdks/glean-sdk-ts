 ...
 */
export function clientAnswersPreviewDraft(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PreviewanswerdraftRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rest/api/v1/previewanswerdraft")();
