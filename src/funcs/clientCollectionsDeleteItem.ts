 ...
 */
export function clientCollectionsDeleteItem(
  client: GleanCore,
...
> {
  const input: operations.DeletecollectionitemRequest = {
  ...
  const body = encodeJSON("body", payload.DeleteCollectionItemRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.DeleteCollectionItemResponse$inboundSchema),
