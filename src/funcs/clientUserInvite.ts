 ...
 */
export function clientUserInvite(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.InviteRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.InviteRequest, { explode: true });

  const path = pathToFunc("/rest/api/v1/invite")();
