 ...
 */
export function indexingTroubleshootingCheckAccess(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.CheckDocumentAccessRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.CheckDocumentAccessResponse$inboundSchema),
