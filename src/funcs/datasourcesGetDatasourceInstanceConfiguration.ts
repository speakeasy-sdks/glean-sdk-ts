 ...
 */
export function datasourcesGetDatasourceInstanceConfiguration(
  client: GleanCore,
  datasourceId: string,
  instanceId: string,
...
> {
  const input: operations.GetDatasourceInstanceConfigurationRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetDatasourceInstanceConfigurationRequest$outboundSchema.parse(
        value,
      ),
