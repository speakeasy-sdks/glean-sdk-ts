 ...
 */
export function clientAnnouncementsPublish(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PublishdraftannouncementRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.PublishDraftAnnouncementRequest, {
    explode: true,
  });

  const path = pathToFunc("/rest/api/v1/publishdraftannouncement")();
