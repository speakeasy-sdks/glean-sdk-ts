 ...
 * Updates an existing policy.
 */
export function clientGovernanceDataPoliciesUpdate(
  client: GleanCore,
...
> {
  const input: operations.UpdatepolicyRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.UpdatepolicyRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.UpdateDlpReportResponse$inboundSchema, {
