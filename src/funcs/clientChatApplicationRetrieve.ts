 ...
 */
export function clientChatApplicationRetrieve(
  client: GleanCore,
...
> {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.GetchatapplicationRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GetChatApplicationResponse$inboundSchema),
