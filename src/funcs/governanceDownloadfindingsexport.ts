 ...
 */
export function governanceDownloadfindingsexport(
  client: GleanCore,
  id: string,
...
> {
  const input: operations.DownloadfindingsexportRequest = {
    id: id,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DownloadfindingsexportRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rest/api/v1/governance/data/findings/exports/{id}")(
    pathParams,
  );
