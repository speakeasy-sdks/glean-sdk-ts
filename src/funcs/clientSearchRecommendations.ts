...
export function clientSearchRecommendations(
  ...
  Result<
    components.ResultsResponse | undefined,
    | GleanError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const input: operations.RecommendationsRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.RecommendationsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.RecommendationsRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ResultsResponse$inboundSchema.optional()),
    M.nil([202, 204], components.ResultsResponse$inboundSchema.optional()),
