 ...
 */
export function clientAnnouncementsCreateDraft(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreatedraftannouncementRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateDraftAnnouncementRequest, {
    explode: true,
  });

  const path = pathToFunc("/rest/api/v1/createdraftannouncement")();
