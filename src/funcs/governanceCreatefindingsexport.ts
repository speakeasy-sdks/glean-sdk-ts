 ...
 */
export function governanceCreatefindingsexport(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.DlpExportFindingsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rest/api/v1/governance/data/findings/exports")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ExportInfo$inboundSchema),
    M.fail([403, "4XX"]),
    M.fail([500, "5XX"]),
  )(response);
  if (!result.ok) {
