 ...
 */
export function clientPinsRetrieve(
  client: GleanCore,
...
> {
  ...
  const body = encodeJSON("body", payload.GetPinRequest, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GetPinResponse$inboundSchema),
