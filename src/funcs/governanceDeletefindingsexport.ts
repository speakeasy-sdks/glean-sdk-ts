 ...
 */
export function governanceDeletefindingsexport(
  client: GleanCore,
  id: number,
...
> {
  const input: operations.DeletefindingsexportRequest = {
    id: id,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.DeletefindingsexportRequest$outboundSchema.parse(value),
