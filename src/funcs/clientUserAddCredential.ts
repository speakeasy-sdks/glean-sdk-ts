 ...
 */
export function clientUserAddCredential(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddcredentialRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.AddCredentialRequest, {
    explode: true,
  });

  const path = pathToFunc("/rest/api/v1/addcredential")();
