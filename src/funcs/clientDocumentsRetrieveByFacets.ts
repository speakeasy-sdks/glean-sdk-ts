 ...
 */
export function clientDocumentsRetrieveByFacets(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.GetDocumentsByFacetsRequest$outboundSchema.optional().parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GetDocumentsByFacetsResponse$inboundSchema),
