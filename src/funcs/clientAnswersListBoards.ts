 ...
 */
export function clientAnswersListBoards(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListanswerboardsRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.ListAnswerBoardsRequest, {
    explode: true,
  });

  const path = pathToFunc("/rest/api/v1/listanswerboards")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ListAnswerBoardsResponse$inboundSchema),
