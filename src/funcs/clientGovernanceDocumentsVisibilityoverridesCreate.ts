 ...
 */
export function clientGovernanceDocumentsVisibilityoverridesCreate(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.UpdateDocumentVisibilityOverridesRequest$outboundSchema.parse(
        value,
      ),
  ...
  >(
    M.json(
      200,
      components.UpdateDocumentVisibilityOverridesResponse$inboundSchema,
