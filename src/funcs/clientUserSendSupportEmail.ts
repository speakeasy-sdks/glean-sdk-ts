 ...
 */
export function clientUserSendSupportEmail(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SupportEmailRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.EmailRequest, { explode: true });

  const path = pathToFunc("/rest/api/v1/support")();
