 ...
 */
export function clientGovernanceDataReportsDownload(
  client: GleanCore,
  id: string,
...
> {
  const input: operations.DownloadreportcsvRequest = {
    id: id,
  };

  const parsed = safeParse(
    input,
    (value) => operations.DownloadreportcsvRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rest/api/v1/governance/data/reports/{id}/download")(
    pathParams,
  );
