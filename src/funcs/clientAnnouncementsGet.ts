 ...
 */
export function clientAnnouncementsGet(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetannouncementRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rest/api/v1/getannouncement")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GetAnnouncementResponse$inboundSchema),
