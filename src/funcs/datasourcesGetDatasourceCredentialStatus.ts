 ...
 */
export function datasourcesGetDatasourceCredentialStatus(
  client: GleanCore,
...
> {
  const input: operations.GetDatasourceCredentialStatusRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.GetDatasourceCredentialStatusRequest$outboundSchema.parse(
        value,
      ),
