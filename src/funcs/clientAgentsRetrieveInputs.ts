 ...
 */
export function clientAgentsRetrieveInputs(
  client: GleanCore,
...
> {
  ...
  const body = encodeJSON("body", payload.GetAgentInputsRequest, {
    explode: true,
  });

  const path = pathToFunc("/rest/api/v1/getagentinputs")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GetAgentInputsResponse$inboundSchema),
