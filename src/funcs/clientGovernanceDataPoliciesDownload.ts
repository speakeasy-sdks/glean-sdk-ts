 ...
 */
export function clientGovernanceDataPoliciesDownload(
  client: GleanCore,
  id: string,
...
> {
  const input: operations.DownloadpolicycsvRequest = {
    id: id,
  };

  const parsed = safeParse(
    input,
    (value) => operations.DownloadpolicycsvRequest$outboundSchema.parse(value),
