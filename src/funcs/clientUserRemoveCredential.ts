 ...
 */
export function clientUserRemoveCredential(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RemovecredentialRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.RemoveCredentialRequest, {
    explode: true,
  });

  const path = pathToFunc("/rest/api/v1/removecredential")();
