 ...
 */
export function clientShortcutsRetrieve(
  client: GleanCore,
...
> {
  const input: operations.GetshortcutRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.GetshortcutRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.GetShortcutRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GetShortcutResponse$inboundSchema),
