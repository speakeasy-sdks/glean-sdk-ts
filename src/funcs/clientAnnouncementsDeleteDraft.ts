 ...
 */
export function clientAnnouncementsDeleteDraft(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeletedraftannouncementRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rest/api/v1/deletedraftannouncement")();
