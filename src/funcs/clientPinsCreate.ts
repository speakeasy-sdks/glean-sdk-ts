 ...
 */
export function clientPinsCreate(
  client: GleanCore,
...
> {
  const input: operations.PinRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.PinRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.PinRequest, { explode: true });
