 ...
 */
export function indexingDatasourcesConfigRetrieve(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.GetDatasourceConfigRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.CustomDatasourceConfig$inboundSchema),
