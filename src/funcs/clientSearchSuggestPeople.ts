 ...
 */
export function clientSearchSuggestPeople(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.PeoplesuggestRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/rest/api/v1/peoplesuggest")();
