 ...
 */
export function clientCollectionsAddItems(
  client: GleanCore,
...
> {
  const input: operations.AddcollectionitemsRequest = {
  ...
  const body = encodeJSON("body", payload.AddCollectionItemsRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.AddCollectionItemsResponse$inboundSchema),
