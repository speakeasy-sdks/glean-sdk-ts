 ...
 */
export function clientGovernanceDataReportsCreate(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.UpdateDlpConfigRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.UpdateDlpConfigResponse$inboundSchema, {
