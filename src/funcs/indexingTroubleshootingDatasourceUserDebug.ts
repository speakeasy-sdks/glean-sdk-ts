 ...
 */
export function indexingTroubleshootingDatasourceUserDebug(
  client: GleanCore,
...
> {
  const input: operations.PostApiIndexV1DebugDatasourceUserRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.PostApiIndexV1DebugDatasourceUserRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.DebugUserResponse$inboundSchema, {
