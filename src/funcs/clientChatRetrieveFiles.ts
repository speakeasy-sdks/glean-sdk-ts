 ...
 * Get files uploaded by a user for Chat.
 */
export function clientChatRetrieveFiles(
  client: GleanCore,
...
> {
  const input: operations.GetchatfilesRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => operations.GetchatfilesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.GetChatFilesResponse$inboundSchema),
