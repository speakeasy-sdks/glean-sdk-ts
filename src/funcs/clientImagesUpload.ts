 ...
 */
export function clientImagesUpload(
  client: GleanCore,
  request: operations.UploadimageRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.UploadImageResponse,
    | GleanError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const path = pathToFunc("/rest/api/v1/uploadimage")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.UploadImageResponse$inboundSchema),
