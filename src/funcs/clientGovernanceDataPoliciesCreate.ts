 ...
 */
export function clientGovernanceDataPoliciesCreate(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.CreateDlpReportRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.CreateDlpReportResponse$inboundSchema, {
