 ...
 */
export function clientAnnouncementsUnpublish(
  client: GleanCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UnpublishannouncementRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UnpublishAnnouncementRequest, {
    explode: true,
  });

  const path = pathToFunc("/rest/api/v1/unpublishannouncement")();
