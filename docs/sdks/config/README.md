# Config
(*indexing.datasources.config*)

## Overview

### Available Operations

* [retrieve](#retrieve) - Get datasource config
...
import { indexingDatasourcesConfigRetrieve } from "@gleanwork/api-client/funcs/indexingDatasourcesConfigRetrieve.js";
...
async function run() {
  const res = await indexingDatasourcesConfigRetrieve(glean, {
    datasource: "<value>",
  });
...
import {
  ...
  useIndexingDatasourcesConfigRetrieveMutation
} from "@gleanwork/api-client/react-query/indexingDatasourcesConfigRetrieve.js";
```
