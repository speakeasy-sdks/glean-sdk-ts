...
* [retrieve](#retrieve) - Gets the metadata for a custom Chat application
...
import { clientChatApplicationRetrieve } from "@gleanwork/api-client/funcs/clientChatApplicationRetrieve.js";
...
async function run() {
  const res = await clientChatApplicationRetrieve(glean, {
    id: "<id>",
  });
...
import {
  ...
  useClientChatApplicationRetrieveMutation
} from "@gleanwork/api-client/react-query/clientChatApplicationRetrieve.js";
```
