...
import { clientAgentsAgentRun } from "@gleanwork/api-client/funcs/clientAgentsAgentRun.js";
...
async function run() {
  const res = await clientAgentsAgentRun(glean, {});
...
import {
  ...
  useClientAgentsAgentRunMutation
} from "@gleanwork/api-client/react-query/clientAgentsAgentRun.js";
```
