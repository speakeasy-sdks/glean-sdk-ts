...
import { verificationVerify } from "@gleanwork/api-client/funcs/verificationVerify.js";
...
async function run() {
  const res = await verificationVerify(glean, {
    documentId: "<id>",
  });
...
} from "@gleanwork/api-client/react-query/verificationVerify.js";
```
