...
import { clientAuthenticationCreateAnonymousToken } from "@gleanwork/api-client/funcs/clientAuthenticationCreateAnonymousToken.js";
...
async function run() {
  const res = await clientAuthenticationCreateAnonymousToken(glean);
...
import {
  ...
  useClientAuthenticationCreateAnonymousTokenMutation
} from "@gleanwork/api-client/react-query/clientAuthenticationCreateAnonymousToken.js";
```
