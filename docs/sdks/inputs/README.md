# Inputs
(*client.agents.agent.inputs*)

## Overview

### Available Operations

* [retrieve](#retrieve) - Gets the inputs to an agent.
...
import { clientAgentsAgentInputsRetrieve } from "@gleanwork/api-client/funcs/clientAgentsAgentInputsRetrieve.js";
...
async function run() {
  const res = await clientAgentsAgentInputsRetrieve(glean, {});
...
import {
  ...
  useClientAgentsAgentInputsRetrieveMutation
} from "@gleanwork/api-client/react-query/clientAgentsAgentInputsRetrieve.js";
```
