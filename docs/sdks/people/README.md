...
async function run() {
  await glean.indexing.people.bulkIndexEmployees({
    uploadId: "<id>",
    employees: [],
  });
...
```typescript
import { GleanCore } from "@gleanwork/api-client/core.js";
import { indexingPeopleBulkIndexEmployees } from "@gleanwork/api-client/funcs/indexingPeopleBulkIndexEmployees.js";
...
async function run() {
  const res = await indexingPeopleBulkIndexEmployees(glean, {
    uploadId: "<id>",
    employees: [],
  });
...
import {
  // Mutation hook for triggering the API call.
  useIndexingPeopleBulkIndexEmployeesMutation
} from "@gleanwork/api-client/react-query/indexingPeopleBulkIndexEmployees.js";
```
