...
(*client.documents.permissions*)

## Overview

### Available Operations

* [retrieve](#retrieve) - Read document permissions
...
import { clientDocumentsPermissionsRetrieve } from "@gleanwork/api-client/funcs/clientDocumentsPermissionsRetrieve.js";
...
async function run() {
  const res = await clientDocumentsPermissionsRetrieve(glean, {});
...
import {
  ...
  useClientDocumentsPermissionsRetrieveMutation
} from "@gleanwork/api-client/react-query/clientDocumentsPermissionsRetrieve.js";
```
