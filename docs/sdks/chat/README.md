...
```typescript
import { GleanCore } from "@gleanwork/api-client/core.js";
import { clientChatStartStream } from "@gleanwork/api-client/funcs/clientChatStartStream.js";
...
async function run() {
  const res = await clientChatStartStream(glean, {
    messages: [
      {
        fragments: [
          {
...
} from "@gleanwork/api-client/react-query/clientChatStartStream.js";
```
