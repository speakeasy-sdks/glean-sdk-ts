...
| `numGleanbotInteractions`                                                               | *number*                                                                                | :heavy_minus_sign:                                                                      | Total number of Gleanbot interacted with by this user over the specified time period.   |                                                                                         |
| `numDaysActive`                                                                         | *number*                                                                                | :heavy_minus_sign:                                                                      | Total number of days this user was active over the specified time period.               |                                                                                         |